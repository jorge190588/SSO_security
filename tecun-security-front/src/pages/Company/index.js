...
class Company extends Component {     
    constructor(props) {
        ...
        this.state = {
            ...
            customActions:[],
            elements:   {
                name: {         idelement: "name", value:'', label: "Nombre", pattern:"^[\\w_\\sÑñáéíóúÁÉÍÓÚ.]{3,30}$", validators: ['required'], errorMessages:['Campo requiere un texto de 4 a 20 caracteres (Ejemplo: Añejos)'], isError:false, elementType:'input' },
                code: {         idelement: "code", value:'', label: "Código", pattern:"^[\\w_\\sÑñáéíóúÁÉÍÓÚ.-]{0,10}$", validators: ['required'], errorMessages:['Campo requiere un texto de 3 caracteres (Ejemplo: 001)'], isError:false, elementType:'input' },
                description: {  idelement: "description", value:'', label: "Descripción", pattern:"^[\\w_\\sÑñáéíóúÁÉÍÓÚ.]{0,100}$", validators: ['required'], errorMessages:['Campo requiere un texto de 0 a 30 caracteres (Ejemplo: Añejamiento de barricas)'], isError:false, elementType:'input' },
            }
        }
